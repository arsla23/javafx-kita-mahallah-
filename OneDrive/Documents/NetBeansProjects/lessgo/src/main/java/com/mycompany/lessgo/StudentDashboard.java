...
public class StudentDashboard extends Application {
    ...
    private String userMahallah = "Bilal Ibn Rabah";
    private Stage loginStage;
    
    // Constructor to pass login stage reference
    public StudentDashboard() {}
    
    public StudentDashboard(Stage loginStage) {
    ...
    private HBox createHeader(Stage currentStage) {
        ...
        Label userLabel = new Label("Student: Ali Ibn Talib | Room: B-301");
        userLabel.setStyle("-fx-text-fill: white; -fx-font-size: 14px;");
        
        // Logout button
        Button logoutBtn = new Button("Logout");
        logoutBtn.setStyle("-fx-background-color: #f44336; -fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 8 20; -fx-background-radius: 5;");
    ...
    private VBox createMahallahInfo() {
        ...
        changeRoomBtn.setStyle("-fx-background-color: #4CAF50; -fx-text-fill: white; -fx-pref-width: 180; -fx-background-radius: 5;");
        
        Button roommatesBtn = new Button("View Roommates");
        roommatesBtn.setStyle("-fx-background-color: #2196F3; -fx-text-fill: white; -fx-pref-width: 180; -fx-background-radius: 5;");
        
        Button facilitiesBtn = new Button("Mahallah Facilities");
        facilitiesBtn.setStyle("-fx-background-color: #FF9800; -fx-text-fill: white; -fx-pref-width: 180; -fx-background-radius: 5;");
        
        // Add hover effects
        addButtonHoverEffect(changeRoomBtn, "#66BB6A", "#4CAF50");
        addButtonHoverEffect(roommatesBtn, "#42A5F5", "#2196F3");
        addButtonHoverEffect(facilitiesBtn, "#FFB74D", "#FF9800");
    ...
    private VBox createNotificationsPanel() {
        ...
        viewAllBtn.setStyle("-fx-background-color: #4CAF50; -fx-text-fill: white; -fx-font-weight: bold; -fx-background-radius: 5;");
        
        panel.getChildren().addAll(title, notificationsList, viewAllBtn);
        return panel;
    }
    
    private void addButtonHoverEffect(Button btn, String hoverColor, String normalColor) {
        btn.setOnMouseEntered(e -> btn.setStyle("-fx-background-color: " + hoverColor + "; -fx-text-fill: white; -fx-pref-width: 180; -fx-background-radius: 5;"));
        btn.setOnMouseExited(e -> btn.setStyle("-fx-background-color: " + normalColor + "; -fx-text-fill: white; -fx-pref-width: 180; -fx-background-radius: 5;"));
    }
    
    private void openRoomApplication() {
        RoomApplication roomApp = new RoomApplication();
        Stage roomStage = new Stage();
        roomStage.setTitle("KITA Mahallah - Room Application");
        roomApp.start(roomStage);
    }
